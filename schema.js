        ...
        fields: [
          {
            ...
            elements: [
              ...
              { key: "wall1",       label: "Wall 1(right side wall after entering from room)",         icon: "🧱" },
              { key: "wall2",       label: "Wall 2(left side wall after entering from room)",         icon: "🧱" },
              { key: "wall3",       label: "Wall 3(front side wall after entering from room)",         icon: "🧱" },
              { key: "wall4",       label: "Wall 4(Same door wall after entering the room)",         icon: "🧱" },
