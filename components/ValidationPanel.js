...
const GLOBAL_STYLES = `
  ...
  @keyframes vp-pulse-glow  { 0%,100%{box-shadow:0 0 12px var(--vp-glow-indigo)} 50%{box-shadow:0 0 32px var(--vp-glow-indigo),0 0 60px rgba(99,102,241,0.15)} }
  ...
  .vp-tab-btn:hover { color: var(--vp-text-primary) !important; background: rgba(99,102,241,0.08) !important }
